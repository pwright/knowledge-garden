- Want to use `nodeport` ingress for a kind cluster on macOS?
	...
	- You can also port forward the skupper-router services, for example:
	  `kubectl port-forward  service/skupper-router 30794:55671`
	  `kubectl port-forward  service/skupper-router 31507:45671`